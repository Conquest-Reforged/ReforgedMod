...
import com.conquestreforged.blocks.block.overlay_top.*;
...
public class RoughNaturalRockInit {
    ...
    public static void init(TypeList types, TypeList typesRocks, TypeList typesVanilla, TypeList typesRocksVanilla) {
        VanillaProps.stone()
                ...
                .parent(Blocks.PRISMARINE.defaultBlockState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("light_mudstone")
                .texture("minecraft:block/white_terracotta")
                .parent(Blocks.WHITE_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("orange_mudstone")
                .texture("minecraft:block/orange_terracotta")
                .parent(Blocks.ORANGE_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("yellow_mudstone")
                .texture("minecraft:block/yellow_terracotta")
                .parent(Blocks.YELLOW_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("gray_cave_silt")
                .texture("minecraft:block/gray_terracotta")
                .parent(Blocks.GRAY_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("brown_mudstone")
                .texture("minecraft:block/brown_terracotta")
                .parent(Blocks.BROWN_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("red_mudstone")
                .texture("minecraft:block/red_terracotta")
                .parent(Blocks.RED_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("red_clay")
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.BLACK_TERRACOTTA.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("pahoehoe")
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.MAGMA_BLOCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("obsidian")
                .texture("minecraft:block/obsidian")
                .parent(Blocks.OBSIDIAN.defaultBlockState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.END_STONE.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("peridotite")
                .texture("minecraft:block/bedrock")
                .parent(Blocks.BEDROCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.COAL_BLOCK.defaultBlockState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.SNOW_BLOCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("tuff")
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.BLACKSTONE.defaultBlockState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.GILDED_BLACKSTONE.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("crying_obsidian")
                .texture("*", "minecraft:block/crying_obsidian")
                .parent(Blocks.CRYING_OBSIDIAN.defaultBlockState())
                .register(typesVanilla);
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.RAW_COPPER_BLOCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("raw_gold")
                .texture("minecraft:block/raw_gold_block")
                .parent(Blocks.RAW_GOLD_BLOCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("raw_iron")
                .texture("minecraft:block/raw_iron_block")
                .parent(Blocks.RAW_IRON_BLOCK.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("calcite_and_limestone")
                .texture("minecraft:block/calcite")
                .parent(Blocks.CALCITE.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
                .name("pumice")
                .texture("minecraft:block/smooth_basalt")
                .parent(Blocks.SMOOTH_BASALT.defaultBlockState())
                .register(typesVanilla);
        VanillaProps.stone()
                .group(ModGroups.STONE)
