...
public class LargeStoneSlabsInit {
    ...
    public static void init(TypeList types, TypeList typesVanilla, TypeList typesVanillaNoStairs) {
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.LIGHT_GRAY_CONCRETE.defaultBlockState())
