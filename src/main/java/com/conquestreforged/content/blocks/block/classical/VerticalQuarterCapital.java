...
import com.conquestreforged.content.blocks.block.VerticalQuarterLessLayers;
...
public class VerticalQuarterCapital extends VerticalQuarterLessLayers {
    ...
    public VerticalQuarterCapital(Props properties) {
        super(properties);
    ...
    public boolean canConnectTo(BlockState state, Direction stateDirectionOriginal) {
        ...
        boolean flag2 = block instanceof VerticalQuarterCapital && (state.get(DIRECTION) == stateDirectionOriginal.rotateYClockwise() || state.get(DIRECTION) == stateDirectionOriginal.rotateYCounterclockwise());
        return flag2 || flag1;
    }
