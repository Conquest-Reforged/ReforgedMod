...
import com.conquestreforged.content.blocks.block.damage.DirectionalModelDamage;
import com.conquestreforged.content.blocks.block.decor.*;
import com.conquestreforged.content.blocks.block.directional.*;
import com.conquestreforged.content.blocks.block.food.*;
import com.conquestreforged.content.blocks.block.glass.*;
import com.conquestreforged.content.blocks.block.overlay_wall.OverlayVerticalCornerThin;
import com.conquestreforged.content.blocks.block.overlay_wall.OverlayVerticalQuarterThin;
import com.conquestreforged.content.blocks.block.overlay_wall.OverlayVerticalSlabThin;
import com.conquestreforged.content.blocks.block.tech.Dispenser;
import com.conquestreforged.content.blocks.block.tech.Dropper;
import com.conquestreforged.content.blocks.block.tech.Furnace;
...
public class BlocksNoVariantsInit {
    ...
    public static void init() {
        VanillaProps.planks()
                ...
                .manual()
                .with("hitBox", BlockVoxelShapes.halfCauldronShape)
        ...
        VanillaProps.stone()
                ...
                .register(TypeList.of(WallOld.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
                .name("reinforced_wooden_trapdoor")
                .manual()
                .register(TypeList.of(Trapdoor.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .register(TypeList.of(FourWay.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
                .name("wicker_fence")
                .manual()
        ...
        VanillaProps.planks()
                ...
                .family("wicker_fence")
                .manual()
                .register(TypeList.of(OverlayVerticalCornerThin.class));
        VanillaProps.planks()
                .name("wicker_fence_thin_vertical_slab")
                .family("wicker_fence")
                .manual()
                .register(TypeList.of(OverlayVerticalSlabThin.class));
        VanillaProps.planks()
                .name("wicker_fence_thin_vertical_quarter")
                .family("wicker_fence")
                .manual()
                .register(TypeList.of(OverlayVerticalQuarterThin.class));
        VanillaProps.planks()
        ...
        VanillaProps.planks()
                ...
                .register(TypeList.of(FenceVanilla.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .register(TypeList.of(FenceVanilla.class, FenceGate.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
                .name("wooden_rail")
                .manual()
        ...
        VanillaProps.planks()
                ...
                .name("rustic_fence")
                .manual()
                .register(TypeList.of(FenceToggle.class));
        VanillaProps.planks()
                .name("rustic_cross") //fence_gate
                .family("rustic_fence")
                .manual()
                .register(TypeList.of(FenceGate.class));
        VanillaProps.planks()
                .name("rustic_fence_gate") //fence_gate
                .family("rustic_fence")
                .manual()
                .register(TypeList.of(SmallDoor.class));
        VanillaProps.stone()
                .group(ModGroups.ADVANCED_MASONRY_AND_CERAMICS)
                .name("schist_dragon_head")
                .manual()
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.dragonHeadShapes)
                .register(TypeList.of(HorizontalDirectional.class));
        VanillaProps.stone()
                .group(ModGroups.ADVANCED_MASONRY_AND_CERAMICS)
        ...
        VanillaProps.metal()
                ...
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(Stairs.class));
        VanillaProps.metal()
                .name("diagonal_metal_railings")
                .family("horizontal_metal_railings")
                .manual()
                .register(TypeList.of(Railings.class));
        VanillaProps.metal()
                .group(ModGroups.METAL)
        ...
        VanillaProps.metal()
                ...
                .family("horizontal_metal_railings")
                .manual()
                .register(TypeList.of(RailingsCorner.class));
        VanillaProps.planks()
        ...
        VanillaProps.metal()
                ...
                .manual()
                .register(TypeList.of(Dispenser.class));
        VanillaProps.metal()
                .group(ModGroups.METAL)
                .name("metal_dropper")
                .manual()
                .register(TypeList.of(Dropper.class));
        VanillaProps.metal()
                .group(ModGroups.ADVANCED_MASONRY_AND_CERAMICS)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(Fence.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.metal()
                ...
                .register(TypeList.of(Pane.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(ShuttersLarge.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .register(TypeList.of(Shutters.class));
        VanillaProps.planks()
                //.group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.planks()
                ...
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(Fence.class, FenceGate.class, Wall.class, Pillar.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
                .name("birch_wood_railing")
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(Fence.class, FenceGate.class, PillarSmall.class));
        VanillaProps.planks()
                .group(ModGroups.ADVANCED_CARPENTRY)
        ...
        VanillaProps.cloth()
                ...
                .register(TypeList.of(PaneOld.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                .name("rigging")//Pane
                .manual()
        ...
        VanillaProps.cloth()
                ...
                .name("rope_ladder")
                .manual()
                .register(TypeList.of(Ladder.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                .name("climbing_rope")
                .manual()
        ...
        VanillaProps.metal()
                ...
                .register(TypeList.of(Glass.class, Pane.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                .name("noose")
                .manual()
        ...
        VanillaProps.cloth()
                ...
                .register(TypeList.of(LadderPane.class));
        VanillaProps.cloth()
                .name("black_curtain_vine")
                .family("black_curtain")
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(VineCurtain.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                .name("blue_curtain")
        ...
        VanillaProps.cloth()
                ...
                .register(TypeList.of(LadderPane.class));
        VanillaProps.cloth()
                .name("brown_curtain_vine")
                .family("brown_curtain")
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(VineCurtain.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                ...
                .register(TypeList.of(LadderPane.class));
        VanillaProps.cloth()
                .name("green_curtain_vine")
                .family("green_curtain")
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(VineCurtain.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                ...
                .register(TypeList.of(LadderPane.class));
        VanillaProps.cloth()
                .name("white_curtain_vine")
                .family("white_curtain")
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(VineCurtain.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
                ...
                .register(TypeList.of(LadderPane.class));
        VanillaProps.cloth()
                .name("purple_curtain_vine")
                .family("purple_curtain")
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(VineCurtain.class));
        VanillaProps.cloth()
                .group(ModGroups.CLOTH_AND_FIBERS)
        ...
        VanillaProps.stone()
                .group(ModGroups.DECORATIONS)
                .name("stone_urn")
                .with("hitBox", BlockVoxelShapes.urnShape)
                .solid(false)
                .register(TypeList.of(ModelBlock.class));
        VanillaProps.stone()
                .group(ModGroups.DECORATIONS)
        ...
        VanillaProps.planks()
                ...
                .register(TypeList.of(AxisFurniture.class, VerticalSlab.class, VerticalCorner.class, VerticalQuarter.class));
        VanillaProps.planks()
                .group(ModGroups.STORAGE)
                .name("spice_rack")
                .texture("end", "block/4_furniture/3_wood/oak_storage_top")
        ...
        VanillaProps.planks()
                ...
                .register(TypeList.of(AxisFurniture.class, VerticalSlab.class, VerticalQuarter.class));
        VanillaProps.planks()
                .group(ModGroups.STORAGE)
                .name("poor_wardrobe")
        ...
        VanillaProps.planks()
                ...
                .manual()
                .solid(false)
                .register(TypeList.of(FourWayFull.class));
        VanillaProps.planks()
                .group(ModGroups.FURNITURE)
                .name("stage_floor")
                .manual()
        ...
        VanillaProps.planks()
                ...
                .parent(Blocks.OAK_PLANKS.getDefaultState())
                .register(TypeList.of(Slab.class));
        VanillaProps.planks()
                .group(ModGroups.FURNITURE)
        ...
        VanillaProps.stone()
                ...
                .name("white_screen")
                .light(state -> 14)
                .texture("block/5_miscellaneous/white_screen")
                .register(TypeList.of(Cube.class));
        VanillaProps.stone()
                .group(ModGroups.UTILITY)
                .name("light_gray_screen")
                .light(state -> 14)
                .texture("block/5_miscellaneous/light_gray_screen")
                .register(TypeList.of(Cube.class));
        VanillaProps.stone()
                .group(ModGroups.UTILITY)
        ...
        VanillaProps.planks()
                ...
                .name("ladder")
                .manual()
                .register(TypeList.of(LadderTrapdoor.class));
        VanillaProps.planks()
                .group(ModGroups.TOOL_BLOCKS)
                .name("big_ladder")
                .manual()
        ...
        VanillaProps.glass()
                ...
                .register(TypeList.of(GlassTranslucent.class));
        VanillaProps.glass()
                .group(ModGroups.STONE)
        ...
        VanillaProps.glass()
                ...
                .register(TypeList.of(GlassTranslucent.class, SlabTranslucent.class));
        VanillaProps.stone()
                .group(ModGroups.WATER_AND_AIR)
                .name("icicles")
                .manual()
        ...
        VanillaProps.stone()
                ...
                .manual()
                .register(TypeList.of(Rocks.class));
        VanillaProps.logs()
        ...
        VanillaProps.metal()
                ...
                .manual()
                .solid(false)
                .register(TypeList.of(BeamVertical.class));
        VanillaProps.metal()
                .family("steel_beam_vertical")
                .name("steel_beam")
                .manual()
                .solid(false)
                .register(TypeList.of(BeamHorizontal.class));
        VanillaProps.metal()
                .family("steel_beam_vertical")
        ...
        VanillaProps.planks()
                .group(ModGroups.METAL)
                .name("iron_and_wood_gear_box")
                .manual()
                .render(RenderLayer.SOLID)
                .with("hitBox", BlockVoxelShapes.cubeFullShape)
                .register(TypeList.of(DirectionalToggle2.class));
        VanillaProps.metal()
                .group(ModGroups.METAL)
                .name("metal_gear_box")
                .manual()
        ...
        VanillaProps.metal()
                .group(ModGroups.METAL)
                .name("circuit_boards_and_screen")
                .manual()
                .render(RenderLayer.SOLID)
                .with("hitBox", BlockVoxelShapes.cubeFullShape)
                .register(TypeList.of(DirectionalToggle2.class));
        ...
        VanillaProps.planks()
                ...
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(PotteryWheel.class));
        VanillaProps.planks()
                .group(ModGroups.FOOD_BLOCKS)
                .name("butter_churn")
                .manual()
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.cubeMediumLargePartialShape)
                .register(TypeList.of(DoubleBlock.class));
        VanillaProps.planks()
                .group(ModGroups.DECORATIONS)
                .name("wall_mounted_moose_antler")
                .manual()
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.verticalSlabShapes)
                .register(TypeList.of(HorizontalDirectional.class));
        ...
        VanillaProps.planks()
                ...
                .manual()
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.spinningWheelShape)
                .register(TypeList.of(HorizontalDirectional.class));
        VanillaProps.planks()
                .group(ModGroups.APPLIANCES)
                .name("grindstone")
        ...
        VanillaProps.planks()
                ...
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.cubeFullShape)
                .register(TypeList.of(DoubleHorizontalDirectional.class));
        VanillaProps.planks()
                .group(ModGroups.DECORATIONS)
                .name("tall_grandfather_clock")
                .manual()
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.cubeFullShape)
                .register(TypeList.of(DoubleHorizontalDirectional.class));
        ...
        VanillaProps.planks()
                ...
                .manual()
                .with("hitBox", BlockVoxelShapes.cubePartialShape)
                .register(TypeList.of(ChairNoToggle.class));
        VanillaProps.planks()
                .group(ModGroups.TOOL_BLOCKS)
                .name("plough")
                .manual()
                .render(RenderLayer.CUTOUT)
                .register(TypeList.of(Plough.class));
        VanillaProps.planks()
                .group(ModGroups.TOOL_BLOCKS)
                .name("carpentry_clamp")
                .manual()
                .blocking(false)
                .render(RenderLayer.CUTOUT)
                .with("hitBox", BlockVoxelShapes.cubePartialShape)
