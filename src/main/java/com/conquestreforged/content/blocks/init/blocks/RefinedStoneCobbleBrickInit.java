...
public class RefinedStoneCobbleBrickInit {
    ...
    public static void init(TypeList types, TypeList typesVanilla, TypeList typesVanillaNoWall, TypeList typesOverlayTop) {
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.STONE_BRICKS.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.grassyStone()
                ...
                .manual()
                .grassColor()
                .parent(Blocks.MOSSY_STONE_BRICKS.getDefaultState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.CRACKED_STONE_BRICKS.getDefaultState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.BRICKS.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
                ...
                .parent(Blocks.RED_SANDSTONE.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
                .name("sandstone")
                ...
                .parent(Blocks.SANDSTONE.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.END_STONE_BRICKS.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.MOSSY_COBBLESTONE.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.grassyStone()
                .group(ModGroups.COBBLE_AND_BRICK)
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.POLISHED_BLACKSTONE.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
                .name("polished_blackstone_bricks")
                .texture("minecraft:block/polished_blackstone_bricks")
                .parent(Blocks.POLISHED_BLACKSTONE_BRICKS.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
                .name("cracked_polished_blackstone_bricks")
                .texture("minecraft:block/polished_blackstone_bricks")
                .parent(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS.getDefaultState())
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.POLISHED_DEEPSLATE.getDefaultState())
                .register(typesVanillaNoWall);
        VanillaProps.stone()
                .group(ModGroups.COBBLE_AND_BRICK)
