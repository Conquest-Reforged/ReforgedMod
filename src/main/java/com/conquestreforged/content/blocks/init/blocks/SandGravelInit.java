...
public class SandGravelInit {
    ...
    public static void init(TypeList types, TypeList typesVanilla, TypeList typesOverlay) {
        ...
        VanillaProps.sand()
                ...
                .parent(Blocks.RED_SAND.getDefaultState())
                .register(typesVanilla);
        VanillaProps.gravel()
                .group(ModGroups.SAND_AND_GRAVEL)
        ...
        VanillaProps.gravel()
                ...
                .parent(Blocks.GRAVEL.getDefaultState())
                .register(typesVanilla);
        ...
        VanillaProps.stone()
                ...
                .parent(Blocks.NETHERRACK.getDefaultState())
                .register(typesVanilla);
        VanillaProps.earth()
                .group(ModGroups.SAND_AND_GRAVEL)
                .name("soul_sand")
                .texture("minecraft:block/soul_sand")
                .parent(Blocks.SOUL_SAND.getDefaultState())
                .register(typesVanilla);
        VanillaProps.sand()
                .group(ModGroups.SAND_AND_GRAVEL)
                .name("ash")
        ...
        VanillaProps.earth()
                ...
                .parent(Blocks.ANCIENT_DEBRIS.getDefaultState())
                .register(typesVanilla);
        VanillaProps.earth()
                .group(ModGroups.SAND_AND_GRAVEL)
                .name("soul_soil")
                .texture("minecraft:block/soul_soil")
                .parent(Blocks.SOUL_SOIL.getDefaultState())
                .register(typesVanilla);
        VanillaProps.sand()
                .group(ModGroups.SAND_AND_GRAVEL)
                .name("blue_salt")
