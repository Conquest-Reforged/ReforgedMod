...
import com.conquestreforged.content.blocks.particles.AnimalParticleData;
import com.conquestreforged.content.blocks.particles.AnimalParticleType;
...
public class ParticleRegistrar {
    ...
    public static void onIParticleTypeRegistration() {
        registerAnimalParticle(raven1ParticleType,"raven_1");
        registerAnimalParticle(raven2ParticleType,"raven_2");
        registerAnimalParticle(raven3ParticleType,"raven_3");
        registerAnimalParticle(raven4ParticleType,"raven_4");
        registerAnimalParticle(ravenFlying1ParticleType,"raven_flying_1");
        registerAnimalParticle(ravenFlying2ParticleType,"raven_flying_2");
        registerAnimalParticle(ravenFlying3ParticleType,"raven_flying_3");
        registerAnimalParticle(ravenFlying4ParticleType,"raven_flying_4");

        registerAnimalParticle(hawk1ParticleType,"hawk_1");
        registerAnimalParticle(hawk2ParticleType,"hawk_2");
        registerAnimalParticle(hawk3ParticleType,"hawk_3");
        registerAnimalParticle(hawk4ParticleType,"hawk_4");
        registerAnimalParticle(hawkFlying1ParticleType,"hawk_flying_1");
        registerAnimalParticle(hawkFlying2ParticleType,"hawk_flying_2");
        registerAnimalParticle(hawkFlying3ParticleType,"hawk_flying_3");
        registerAnimalParticle(hawkFlying4ParticleType,"hawk_flying_4");

        registerAnimalParticle(bat1ParticleType,"bat_1");
        registerAnimalParticle(bat2ParticleType,"bat_2");
        registerAnimalParticle(batFlying1ParticleType,"bat_flying_1");
        registerAnimalParticle(batFlying2ParticleType,"bat_flying_2");
        registerAnimalParticle(batFlying3ParticleType,"bat_flying_3");
        registerAnimalParticle(batFlying4ParticleType,"bat_flying_4");

        registerAnimalParticle(bluejay1ParticleType,"bluejay_1");
        registerAnimalParticle(bluejay2ParticleType,"bluejay_2");
        registerAnimalParticle(bluejay3ParticleType,"bluejay_3");
        registerAnimalParticle(bluejay4ParticleType,"bluejay_4");
        registerAnimalParticle(bluejayFlying1ParticleType,"bluejay_flying_1");
        registerAnimalParticle(bluejayFlying2ParticleType,"bluejay_flying_2");
        registerAnimalParticle(bluejayFlying3ParticleType,"bluejay_flying_3");
        registerAnimalParticle(bluejayFlying4ParticleType,"bluejay_flying_4");

        registerAnimalParticle(duck1ParticleType,"duck_1");
        registerAnimalParticle(duck2ParticleType,"duck_2");
        registerAnimalParticle(duck3ParticleType,"duck_3");
        registerAnimalParticle(duck4ParticleType,"duck_4");
        registerAnimalParticle(duckFlying1ParticleType,"duck_flying_1");
        registerAnimalParticle(duckFlying2ParticleType,"duck_flying_2");
        registerAnimalParticle(duckFlying3ParticleType,"duck_flying_3");
        registerAnimalParticle(duckFlying4ParticleType,"duck_flying_4");

        registerAnimalParticle(owl1ParticleType,"owl_1");
        registerAnimalParticle(owl2ParticleType,"owl_2");
        registerAnimalParticle(owl3ParticleType,"owl_3");
        registerAnimalParticle(owl4ParticleType,"owl_4");
        registerAnimalParticle(owlFlying1ParticleType,"owl_flying_1");

        registerAnimalParticle(pigeon1ParticleType,"pigeon_1");
        registerAnimalParticle(pigeon2ParticleType,"pigeon_2");
        registerAnimalParticle(pigeon3ParticleType,"pigeon_3");
        registerAnimalParticle(pigeon4ParticleType,"pigeon_4");
        registerAnimalParticle(pigeonFlying1ParticleType,"pigeon_flying_1");
        registerAnimalParticle(pigeonFlying2ParticleType,"pigeon_flying_2");
        registerAnimalParticle(pigeonFlying3ParticleType,"pigeon_flying_3");
        registerAnimalParticle(pigeonFlying4ParticleType,"pigeon_flying_4");

        registerAnimalParticle(seagull1ParticleType,"seagull_1");
        registerAnimalParticle(seagull2ParticleType,"seagull_2");
        registerAnimalParticle(seagull3ParticleType,"seagull_3");
        registerAnimalParticle(seagull4ParticleType,"seagull_4");
        registerAnimalParticle(seagullFlying1ParticleType,"seagull_flying_1");
        registerAnimalParticle(seagullFlying2ParticleType,"seagull_flying_2");
        registerAnimalParticle(seagullFlying3ParticleType,"seagull_flying_3");
        registerAnimalParticle(seagullFlying4ParticleType,"seagull_flying_4");

        registerAnimalParticle(puffin1ParticleType,"puffin_1");
        registerAnimalParticle(puffinFlying1ParticleType,"puffin_flying_1");

        registerAnimalParticle(toad1ParticleType,"toad_1");
        registerAnimalParticle(toad2ParticleType,"toad_2");
        registerAnimalParticle(toad3ParticleType,"toad_3");
        registerAnimalParticle(toad4ParticleType,"toad_4");

        registerAnimalParticle(rat1ParticleType,"rat_1");
        registerAnimalParticle(rat2ParticleType,"rat_2");
        registerAnimalParticle(rat3ParticleType,"rat_3");
        registerAnimalParticle(rat4ParticleType,"rat_4");
    }

    private static void registerAnimalParticle (ParticleType<AnimalParticleData> animal, String registryName) {
        Registry.register(Registry.PARTICLE_TYPE, "conquest:"+registryName, animal);
    }
}
