...
public class VanillaProps {
    ...
    public static Props grassLike() {
        return Props.create((Material.SOLID_ORGANIC)).group(ItemGroup.BUILDING_BLOCKS).strength(0.6F, 0.6F).sound(BlockSoundGroup.GRASS).grassColor();
    }
    ...
    public static Props plantLike() {
        return Props.create(Material.WOOL).sound(BlockSoundGroup.GRASS).group(ItemGroup.BUILDING_BLOCKS);
    }
    ...
    public static Props bamboo() {
        return Props.create(Blocks.BAMBOO).group(ItemGroup.BUILDING_BLOCKS);
    }
