...
public class HorizontalDirectionalWaterloggedToggle2 extends HorizontalDirectionalWaterlogged {

    public static final IntProperty TOGGLE = IntProperty.of("toggle", 1, 2);

    public HorizontalDirectionalWaterloggedToggle2(Props props) {
        super(props);
    }
