...
public class TallFlowerVanilla extends TallFlowerBlock {
    ...
    public TallFlowerVanilla(Settings properties) {
        super(properties);
    ...
    public BlockState getPlacementState(ItemPlacementContext context) {
        ...
        if (iblockreader.getBlockState(blockpos.up()).canReplace(context)) {
            if (blockStateDown.contains(Layer.LAYERS) || blockStateDown.contains(Slab.LAYERS) || blockStateDown.contains(TallFlowerVanilla.LAYERS)) {
    ...
    public BlockState getStateForNeighborUpdate(BlockState stateIn, Direction facing, BlockState facingState, WorldAccess worldIn, BlockPos currentPos, BlockPos facingPos) {
        ...
        if ((facing.getAxis() != Direction.Axis.Y || doubleblockhalf == DoubleBlockHalf.LOWER != (facing == Direction.UP) || facingState.getBlock() == this && facingState.get(HALF) != doubleblockhalf) && blockStateDown.contains(Layer.LAYERS) || blockStateDown.contains(Slab.LAYERS) || blockStateDown.contains(TallFlowerVanilla.LAYERS)) {
