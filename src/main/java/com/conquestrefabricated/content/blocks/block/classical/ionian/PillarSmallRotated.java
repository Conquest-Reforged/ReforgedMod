...
@Assets(
        state = @State(name = "%s_small_pillar", template = "parent_balustrade"),
...
public class PillarSmallRotated extends PillarBlock implements Waterloggable {
    ...
    public PillarSmallRotated(Settings properties) {
        super(properties);
