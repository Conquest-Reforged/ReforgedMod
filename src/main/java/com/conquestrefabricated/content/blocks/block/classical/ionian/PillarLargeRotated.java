package com.conquestrefabricated.content.blocks.block.classical.ionian;
...
@Assets(
        state = @State(name = "%s_large_pillar", template = "parent_balustrade"),
...
public class PillarLargeRotated extends PillarBlock implements Waterloggable {
    ...
    public PillarLargeRotated(Settings properties) {
        super(properties);
