...
import com.conquestrefabricated.content.blocks.block.directional.Directional;
...
public class DirectionalToggle2 extends Directional {

    public static final IntProperty TOGGLE = IntProperty.of("toggle", 1, 2);

    public DirectionalToggle2(Props props) {
        super(props);
    }
