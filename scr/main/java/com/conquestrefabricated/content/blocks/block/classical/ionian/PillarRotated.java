...
@Assets(
        state = @State(name = "%s_pillar", template = "parent_balustrade"),
...
public class PillarRotated extends PillarBlock implements Waterloggable {
    ...
    public PillarRotated(Settings properties) {
        super(properties);
