...
import com.conquestrefabricated.content.blocks.block.directional.HorizontalDirectionalWaterlogged;
...
public class HorizontalDirectionalWaterloggedToggle3 extends HorizontalDirectionalWaterlogged {

    public static final IntProperty TOGGLE = IntProperty.of("toggle", 1, 3);

    public HorizontalDirectionalWaterloggedToggle3(Props props) {
        super(props);
    }
