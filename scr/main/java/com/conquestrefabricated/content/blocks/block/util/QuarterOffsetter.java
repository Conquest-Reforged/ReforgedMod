...
public class QuarterOffsetter {
    ...
    private QuarterOffsetter(int min, double[] offsets) {
        this.min = min;
    ...
    //    }
    //
    //    return new Vec3d(x/2, ((double) ((float) (i >> 4 & 15L) / 15.0F) - 1.0D) * 0.05D, z/2);
    //}
    ...
    //}
    //
    //public static QuarterOffsetter range(int layerMin, int layerMax, double start, double increment) {
    //    double[] offsets = new double[(layerMax + 1) - layerMin];
    //    for (int i = 0; i < offsets.length; i++) {
    //        offsets[i] = start + (i * increment);
    //    }
    //    return new QuarterOffsetter(layerMin, offsets);
    //}
    //
    //public static QuarterOffsetter fixed(int layerMin, double... offsets) {
    //    return new QuarterOffsetter(layerMin, offsets);
    //}
}
